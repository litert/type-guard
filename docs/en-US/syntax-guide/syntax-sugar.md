...
| `@TypeName` | Reference a custom type | Reference a registered or inline-defined type | `"@IPv4"`<br>`"@Email"` |
| `@TypeName(args)` | Reference with arguments | Pass arguments to a custom type | `"@range(1,100)"`<br>`"@enum(a,b,c)"` |
